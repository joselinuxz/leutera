...
<head>
    ...
    <meta property="og:title"              content="Welcome to Imperium" />
...
body, th, td, input, textarea, select {
	cursor : url("https://imperium-retro.com/images/cursor/cursor.png"), url("https://imperium-retro.com/images/cursor/cursor-click.png"), pointer;
}
...
a {cursor: url('https://imperium-retro.com/images/cursor/cursor-click.png'), pointer;
		...
		<style>
    .discordtable{position:absolute;margin-left:90%;text-align:left;background:#01010185;border:2px solid #8595bb;padding:9px 8px 6px 47px;border-radius:0 0 10px 10px;color:#fff;margin-top:-0px;font:400 9pt Verdana,Arial,Times New Roman,sans-serif;box-shadow:2px 2px 18px 1px #67e9ff;z-index:10000;transition:all 600ms ease-out}.discordtable:hover{box-shadow:2px 2px 18px 1px #03ff0d;border:2px solid #03ff0d;background:#343f58;transition:all 600ms ease-out;z-index:10000;cursor:pointer}.discordtable img{position:absolute;margin-left:-47px;margin-top:-8px;width:43px}.discordtable small{transition:all 600ms ease-out;display:none}.discordtable:hover small{transition:all 600ms ease-out;display:block}
    </style>
    <a href="https://discord.gg/N75HG8eW59" target="_blank">
		...
		<div class="notranslate" id="">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
					    <li><a href="<?= getLink('addons'); ?>">Addons</a></li>
						<li><a href="<?= getLink('spells'); ?>">Spells</a></li>
						<li><a href="<?= getLink('commands'); ?>">Commands</a></li>
						<li><a href="<?= getLink('server'); ?>">Server info</a></li>
						<li><a href="<?= getLink('task'); ?>">Tasks</a></li>
						<li><a href="<?= getLink('experienceTable'); ?>">Experience Table</a></li>
					</ul>
				</li>
				<?php if($config['gifts_system']): ?>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Buy Points <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<?= getLink('points'); ?>">Automatic Points</a></li>
						<li><a href="<?= getLink('gameshop'); ?>">Shop Offers</a></li>
					</ul>
				</li>
				<?php endif; ?>
			</ul>
