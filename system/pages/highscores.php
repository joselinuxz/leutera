              ...
              <tbody>
				...
				<tr>
                  ...
                  <td><select name="world">
                      <option value="0" selected>Imperium</option>
                    </select></td>
				</tr>
                <tr>
                  <td>Vocation:</td>
                  <td><select name="profession">
					...
					<td><div class="BigButton" style=""><div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style=""></div><input class="BigButtonText" type="submit" value="Submit"></div>
                    </div></td>
				</tr>
				<tr>
                  <td>Category:</td>
...
<p><i>Skills displayed in the Highscores do not include any bonuses (equipment etc.).</i></p>
